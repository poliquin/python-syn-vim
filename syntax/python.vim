...
" Enable pysyn syntax for python files
call pysyn#default('g:pysyn', 1)
call pysyn#default('g:pysyn_syntax', g:pysyn)


" DESC: Disable script loading
if !g:pysyn || !g:pysyn_syntax || pysyn#default('b:current_syntax', 'pysyn')
    finish
endif
...
call pysyn#default('g:pysyn_syntax_all', 1)

" Highlight 'print' as function
call pysyn#default("g:pysyn_syntax_print_as_function", 0)
"
" Highlight 'async/await' keywords
call pysyn#default("g:pysyn_syntax_highlight_async_await", g:pysyn_syntax_all)

" Highlight '=' operator
call pysyn#default('g:pysyn_syntax_highlight_equal_operator', g:pysyn_syntax_all)

" Highlight '*' operator
call pysyn#default('g:pysyn_syntax_highlight_stars_operator', g:pysyn_syntax_all)

" Highlight 'self' keyword
call pysyn#default('g:pysyn_syntax_highlight_self', g:pysyn_syntax_all)

" Highlight indent's errors
call pysyn#default('g:pysyn_syntax_indent_errors', g:pysyn_syntax_all)

" Highlight space's errors
call pysyn#default('g:pysyn_syntax_space_errors', g:pysyn_syntax_all)

" Highlight string formatting
call pysyn#default('g:pysyn_syntax_string_formatting', g:pysyn_syntax_all)
call pysyn#default('g:pysyn_syntax_string_format', g:pysyn_syntax_all)
call pysyn#default('g:pysyn_syntax_string_templates', g:pysyn_syntax_all)
call pysyn#default('g:pysyn_syntax_doctests', g:pysyn_syntax_all)

" Support docstrings in syntax highlighting
call pysyn#default('g:pysyn_syntax_docstrings', 1)

" Highlight builtin objects (True, False, ...)
call pysyn#default('g:pysyn_syntax_builtin_objs', g:pysyn_syntax_all)

" Highlight builtin types (str, list, ...)
call pysyn#default('g:pysyn_syntax_builtin_types', g:pysyn_syntax_all)

" Highlight builtin types (div, eval, ...)
call pysyn#default('g:pysyn_syntax_builtin_funcs', g:pysyn_syntax_all)

" Highlight exceptions (TypeError, ValueError, ...)
call pysyn#default('g:pysyn_syntax_highlight_exceptions', g:pysyn_syntax_all)

" More slow synchronizing. Disable on the slow machine, but code in docstrings
" could be broken.
call pysyn#default('g:pysyn_syntax_slow_sync', 1)
...
" ============
    ...
    if !g:pysyn_syntax_print_as_function
        syn keyword pythonStatement print
    endif

    if g:pysyn_syntax_highlight_async_await
    ...
    if g:pysyn_syntax_highlight_equal_operator
        syn match pythonExtraOperator "\%(=\)"
    endif

    if g:pysyn_syntax_highlight_stars_operator
        syn match pythonExtraOperator "\%(\*\|\*\*\)"
    endif

    if g:pysyn_syntax_highlight_self
...
" ==========
    ...
    if g:pysyn_syntax_indent_errors
        syn match pythonIndentError "^\s*\( \t\|\t \)\s*\S"me=e-1 display
    endif

    " Trailing space errors
    if g:pysyn_syntax_space_errors
...
" ===========
    ...
    " String formatting
    if g:pysyn_syntax_string_formatting
        syn match pythonStrFormatting  "%\(([^)]\+)\)\=[-#0 +]*\d*\(\.\d\+\)\=[hlL]\=[diouxXeEfFgGcrs%]" contained containedin=pythonString,pythonUniString,pythonRawString,pythonUniRawString
        syn match pythonStrFormatting  "%[-#0 +]*\(\*\|\d\+\)\=\(\.\(\*\|\d\+\)\)\=[hlL]\=[diouxXeEfFgGcrs%]" contained containedin=pythonString,pythonUniString,pythonRawString,pythonUniRawString
    endif

    " Str.format syntax
    if g:pysyn_syntax_string_format
    ...
    " String templates
    if g:pysyn_syntax_string_templates
    ...
    " DocTests
    if g:pysyn_syntax_doctests
        syn region pythonDocTest    start="^\s*>>>" end=+'''+he=s-1 end="^\s*$" contained
        syn region pythonDocTest2   start="^\s*>>>" end=+"""+he=s-1 end="^\s*$" contained
    endif

    " DocStrings
    if g:pysyn_syntax_docstrings
...
" ============
    ...
    if g:pysyn_syntax_builtin_objs
        syn keyword pythonBuiltinObj True False Ellipsis None NotImplemented
        syn keyword pythonBuiltinObj __debug__ __doc__ __file__ __name__ __package__
    endif

    if g:pysyn_syntax_builtin_types
    ...
    " Builtin functions
    if g:pysyn_syntax_builtin_funcs
    ...
    if g:pysyn_syntax_highlight_exceptions
